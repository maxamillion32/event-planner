...
var SignUp = (function() {
	...
	let _valCheckSpecialEl =		document.getElementById('val-check-special');
	...
	return class SignUp {
		 ...
		 * 
		 */
		static get submitPasswordButton() {
		 ...
		 * 
		 */
		static get signupAdditionalInfoEl() {
